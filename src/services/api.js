...
const API_URL = `https://api.eia.gov/v2/electricity/rto/fuel-type-data/data/?api_key=${API_KEY}&frequency=hourly&data[0]=value&facets[fueltype][]=NUC&sort[0][column]=period&sort[0][direction]=desc&sort[1][column]=value&sort[1][direction]=desc&offset=0&length=1000`
